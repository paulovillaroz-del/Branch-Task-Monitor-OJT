...
const stats = [
  { title: "Total Tasks", value: "247", subtitle: undefined, change: "+12%", trend: "up", icon: CheckCircle },
  { title: "Pending", value: "5", subtitle: undefined, change: "", trend: "down", icon: Clock },
  { title: "In Progress", value: "8", subtitle: undefined, change: "+2", trend: "up", icon: Target },
  { title: "Completed", value: "15", subtitle: undefined, change: "+4", trend: "up", icon: CheckCircle },
  { title: "Overdue", value: "0", subtitle: undefined, change: "", trend: "down", icon: TrendingDown },
]
